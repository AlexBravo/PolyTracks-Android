...
public class LoginActivity extends Activity {
    ...
    private static final String CLIENT_ID = "a6bebbcfaa20431f8683dcff2e5c3464";
    @SuppressWarnings("SpellCheckingInspection")
    ...
    public void onLoginButtonClicked(View view) {
        final AuthenticationRequest request = new AuthenticationRequest.Builder(CLIENT_ID, AuthenticationResponse.Type.TOKEN, REDIRECT_URI)
                .setScopes(new String[]{"playlist-read", "streaming", "playlist-read-private", "playlist-modify-public", "playlist-modify-private", "playlist-read-collaborative"})
                .build();
